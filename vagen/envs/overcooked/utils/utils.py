...
def parse_free_wm(response: str, action_sep: str = ",", max_actions: int = 1) -> Dict:
    """
...
def parse_response(response: str, prompt_format: str = "free_think", action_sep: str = ",", max_actions: int = 1) -> Dict:
